  ...
  getRoot() {
    return {
      ...
      endpoints: {
        ...
        connecteam: {
          status: 'GET /connecteam/status',
          sync: 'POST /connecteam/sync',
          users: 'GET /connecteam/users',
          jobs: 'GET /connecteam/jobs',
          timeClocks: 'GET /connecteam/time-clocks',
          timeActivities: 'GET /connecteam/time-activities',
          schedulers: 'GET /connecteam/schedulers',
          scheduledShifts: 'GET /connecteam/scheduled-shifts',
          forms: 'GET /connecteam/forms',
          formSubmissions: 'GET /connecteam/form-submissions',
          timeOff: 'GET /connecteam/time-off',
          taskBoards: 'GET /connecteam/task-boards',
          tasks: 'GET /connecteam/tasks',
          conversations: 'GET /connecteam/conversations',
          reportsHoursByJob: 'GET /connecteam/reports/hours-by-job',
          reportsHoursByUser: 'GET /connecteam/reports/hours-by-user',
          webhookInbound: 'POST /connecteam/webhooks/inbound (public; Connecteam → us)',
          webhookRegisterChat: 'POST /connecteam/webhooks/register-chat (admin)',
          webhookEvents: 'GET /connecteam/webhooks/events',
          conversationDetail: 'GET /connecteam/conversations/:conversationId',
          usersMe: 'GET /connecteam/users/me',
          clockIn: 'POST /connecteam/time-clocks/:timeClockId/clock-in',
          clockOut: 'POST /connecteam/time-clocks/:timeClockId/clock-out',
          createTimeActivity: 'POST /connecteam/time-clocks/:timeClockId/time-activities',
          patchTimeActivity: 'PATCH /connecteam/time-clocks/:timeClockId/time-activities/:shiftId',
          createScheduledShift: 'POST /connecteam/schedulers/:schedulerId/shifts (admin)',
          patchScheduledShift: 'PATCH /connecteam/schedulers/:schedulerId/shifts/:shiftId (admin)',
          deleteScheduledShift: 'DELETE /connecteam/schedulers/:schedulerId/shifts/:shiftId (admin)',
          createTimeOff: 'POST /connecteam/time-off',
          patchTimeOffStatus: 'PATCH /connecteam/time-off/:requestId/status (admin)',
          submitForm: 'POST /connecteam/forms/:formId/submissions',
          createTask: 'POST /connecteam/task-boards/:taskBoardId/tasks (admin)',
          patchTask: 'PATCH /connecteam/task-boards/:taskBoardId/tasks/:taskId (admin)',
          deleteTask: 'DELETE /connecteam/task-boards/:taskBoardId/tasks/:taskId (admin)',
          createConversation: 'POST /connecteam/conversations',
          startDm: 'POST /connecteam/conversations/dm/:userId',
          listMessages: 'GET /connecteam/conversations/:conversationId/messages',
          sendMessage: 'POST /connecteam/conversations/:conversationId/messages',
        },
        health: {
